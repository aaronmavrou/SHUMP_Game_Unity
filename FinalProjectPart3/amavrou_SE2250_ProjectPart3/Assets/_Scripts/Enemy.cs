...
public class Enemy : MonoBehaviour {
	...
	static public int increaseScore;
	static public int scoreIncrease;

	public int             showDamageForFrames = 2; // # frames to show damage
	public float           powerUpDropChance = 1;  // Chance to drop a power-up
	...
	void Awake() {
		...
		InvokeRepeating( "CheckOffscreen", 0f, 0.1f );
	}
	...
	public virtual void CheckOffscreen() {
